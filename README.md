...
| Ticker | Exchange | Date       | Dividends_CoveredByFCF|.....| Future_ExpectedRevenueGrowthAboveMarket|.....| Health_STLiabilitiesCover            |.....|                                                   | Past Earnings          | Value              |--------|----------|------------|-----------------------|-----| -----------------------------------    |-----| ------------------------------      |------------------------|--------------------------------------|
...
📥 **[Sample Dataset](link_to_csv_or_repo)**
