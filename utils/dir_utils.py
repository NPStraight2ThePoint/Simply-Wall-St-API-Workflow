...
def get_exchanges_csv_path2(TODAY):
    """Returns the file path for the exchanges CSV."""
    return f"C:/.../.venv/Data/Exchanges_Counts/All_{TODAY}.csv"
...
NEW_DATA = Path(
    "C:/.../.venv/Data/Joined Data/NEW_DATA")
EXISTING_DATA = Path(
    "C:/.../.venv/Data/Joined Data/EXISTING_DATA")

FILE_RULES = [
    {"keyword": "insider_transactions", "table": "insider_transactions_uat", "columns": ["exchange", "ticker"]}]

BASE_FOLDER = Path(
    "C:/.../.venv/Data/Joined Data")
